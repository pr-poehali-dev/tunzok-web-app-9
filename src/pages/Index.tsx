  ...
  return (
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/3 w-72 h-72 bg-pink-500/25 rounded-full blur-3xl animate-pulse-slow" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-blue-500/25 rounded-full blur-3xl animate-pulse-slow" style={{animationDelay: '1.5s'}}></div>
      </div>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-8 relative z-10">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8 bg-background/60 backdrop-blur-md border border-primary/10">
            <TabsTrigger value="home" className="transition-all data-[state=active]:bg-primary/20">
              <Icon name="Home" className="h-4 w-4 sm:mr-2" />
              <span className="hidden sm:inline">{t('home')}</span>
            </TabsTrigger>
            <TabsTrigger value="profile" className="transition-all data-[state=active]:bg-primary/20">
              <Icon name="User" className="h-4 w-4 sm:mr-2" />
              <span className="hidden sm:inline">{t('profile')}</span>
            </TabsTrigger>
            <TabsTrigger value="news" className="transition-all data-[state=active]:bg-primary/20">
              <Icon name="Users" className="h-4 w-4 sm:mr-2" />
              <span className="hidden sm:inline">{t('community')}</span>
            </TabsTrigger>
            <TabsTrigger value="settings" className="transition-all data-[state=active]:bg-primary/20">
              <Icon name="Settings" className="h-4 w-4 sm:mr-2" />
